 ...
 */
final class Version20230315144356 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE visit (id INT AUTO_INCREMENT NOT NULL, property_id INT NOT NULL, date DATETIME NOT NULL, INDEX IDX_437EE939549213EC (property_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
